...
export class initialmigration1669080207905 implements MigrationInterface {
    name = 'initialmigration1669080207905'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL, "first_name" character varying(128) NOT NULL, "givern_name" character varying(128) NOT NULL, "email" character varying(128) NOT NULL, "password" character varying(128) NOT NULL, "is_active" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "technical_exam_question" ("id" uuid NOT NULL, "title" character varying(128) NOT NULL, "text" character varying(128) NOT NULL, "is_active" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "exam_id" uuid NOT NULL, CONSTRAINT "PK_05703b3db06a4c0105860bf36a2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "technical_exam" ("id" uuid NOT NULL, "name" character varying(128) NOT NULL, "is_active" boolean NOT NULL, "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, CONSTRAINT "PK_f3806086299596e6bcc721bcc48" PRIMARY KEY ("id"))`);
