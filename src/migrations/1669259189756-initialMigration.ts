...
export class initialMigration1669259189756 implements MigrationInterface {
    name = 'initialMigration1669259189756'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "technical_exam_submission" ("id" uuid NOT NULL, "started_at" TIMESTAMP NOT NULL DEFAULT now(), "finish_at" TIMESTAMP, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "application_id" uuid, CONSTRAINT "PK_c7100a5be13fd5f2cc203cdc511" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "application" ("id" uuid NOT NULL, "score" integer NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, "exam_id" uuid, CONSTRAINT "PK_569e0c3e863ebdf5f2408ee1670" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "technical_exam" ("id" uuid NOT NULL, "name" character varying(128) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f3806086299596e6bcc721bcc48" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "technical_exam_submission_question_alternative" ("id" uuid NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "technicalExamSubmission_id" uuid, "technicalExamQuestion_id" uuid, "technicalExamQuestionAlternative_id" uuid, CONSTRAINT "PK_9e4ae423f4a38c954522f592978" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "technical_exam_questions_alternative" ("id" uuid NOT NULL, "text" character varying(128) NOT NULL, "is_correct" boolean NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "question_id" uuid, CONSTRAINT "PK_8a9b2f576166249752b2c3cc0e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "technical_exam_question" ("id" uuid NOT NULL, "title" character varying(128) NOT NULL, "text" character varying(128) NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "exam_id" uuid NOT NULL, CONSTRAINT "PK_05703b3db06a4c0105860bf36a2" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "technical_exam_question" ADD CONSTRAINT "FK_282042420605f1401a151a37203" FOREIGN KEY ("exam_id") REFERENCES "technical_exam"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "technical_exam_question" DROP CONSTRAINT "FK_282042420605f1401a151a37203"`);
